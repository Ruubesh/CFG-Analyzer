...
def derive_automatically(result_str, entry_str, grammar):
    ...
    if state_sets[(final_state_set, '')] == [final_state]:
        result_str.set(f"{entry_str.get()} is in the language generated by the grammar")
    else:
        result_str.set(f"{entry_str.get()} is not in the language generated by the grammar")
